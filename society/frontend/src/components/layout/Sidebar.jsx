...
import { HouseDoor, Megaphone, CashStack, ClipboardData, People, ClipboardCheck, JournalText, PeopleFill } from 'react-bootstrap-icons';
import './layout.css';
...
export function Sidebar() {
  ...
  if (hasRole('security')) {
    // Security only sees Visitors page (no dashboard)
    navItems = [{ to: '/visitors', label: 'Visitors', icon: People }];
  } else {
