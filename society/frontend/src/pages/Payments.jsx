                  ...
                  <td className="text-end">
                    {isCommittee && (
                      <div className="d-inline-flex gap-1">
                        <Button size="sm" variant="outline-success" onClick={() => handleStatusUpdate(payment._id, 'successful')}>
                          Mark Paid
                        </Button>
                        <Button size="sm" variant="outline-danger" onClick={() => handleStatusUpdate(payment._id, 'failed')}>
                          Mark Failed
                        </Button>
                      </div>
                    )}
